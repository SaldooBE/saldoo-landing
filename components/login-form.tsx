            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  Log in op je Saldoo Mini account
                </p>
              </div>
              <Field>
              ...
              <Field>
                <Button type="submit" style={{ backgroundColor: 'rgba(2, 55, 124, 0.75)' }} className="hover:opacity-90">Inloggen</Button>
              </Field>
              <FieldSeparator className="*:data-[slot=field-separator-content]:bg-card">
                Of ga verder met
              </FieldSeparator>
              <Field className="grid grid-cols-1 gap-4">
                <Button variant="outline" type="button" className="w-full flex items-center justify-center gap-3">
              ...
              <FieldDescription className="text-center">
                Nog geen account? <a href="/signup">Registreren</a>
              </FieldDescription>
            </FieldGroup>
          </form>
